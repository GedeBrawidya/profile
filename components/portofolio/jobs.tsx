...
const jobs = [
  {
    ...
    status: "current",
    description: "Leading frontend & Backend architecture and mentoring members in IT",
  ...
  },
  {
    ...
    status: "past",
    description: "Developed Frontend web applications for Sumatra Floods",
  ...
  },
  {
    ...
    location: "Yogyakarta, Indonesia",
    status: "current",
    description: "Assisting students in practical labs for Algorithm & Program courses",
  ...
  },
  {
    ...
    location: "Remote",
    status: "current",
    description: "Make modern and responsive websites for small businesses and individuals",
    highlights: ["TypeScript", "Vercel", "Supabase", "react.js", "laravel", "express.js"],
  },
]
